...
const CAPABILITY_SEEDS = Object.freeze({
  ...
  enter_copy_mode: c("manage", "none", ["observe", "change"], META),
  exit_copy_mode: c("manage", "none", ["observe", "change"], META),
...
const INPUT_KEYS = Object.freeze({
  ...
  enter_copy_mode: ["paneId", "scrollUp"],
  exit_copy_mode: ["paneId"],
...
const INPUT_SINKS = Object.freeze({
  ...
  enter_copy_mode: { paneId: LOOKUP, scrollUp: STATE },
  exit_copy_mode: { paneId: LOOKUP },
